module.exports = {
  ...
  rules: {
    ...
    "valid-jsdoc": ["error"],                   //使用 JSDoc 注释风格
...
// Stylistic Issues
    ...
    "indent": ["error", 4, {"SwitchCase": 1}],                              //代码缩进
